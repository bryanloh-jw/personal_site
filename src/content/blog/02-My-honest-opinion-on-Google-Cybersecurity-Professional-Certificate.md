...
To give some background about myself, I am a self-taught software developer with almost 2 years of professional experience. The reason why I decided to take the [Google Cybersecurity Professional Certificate](https://www.coursera.org/professional-certificates/google-cybersecurity) is to transition to the security field. I thought that it would be a good place to start learning about the cybersecurity field.
...
Do take note that I am taking this course after I have completed the [ISC2 Certified in Cybersecurity](https://www.isc2.org/certifications/cc) exam so I have some basic understanding of cybersecurity concepts.
...
First, I would start with the CompTIA Security+ certification because it is much more recognized in the industry. There is free training available from [Professor Messer](https://www.professormesser.com/security-plus/sy0-701/sy0-701-video/sy0-701-comptia-security-plus-course/) that covers the knowledge required for the Security+ certification.
